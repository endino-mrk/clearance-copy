...
// /**
//  * Get the user type for the current logged-in user
...
//  */
// function isManager() {
//     return getCurrentUserType() === 'Manager';
// }

// /**
//  * Check if the current user is a Treasurer
//  * @return bool True if the user is a Treasurer, false otherwise
//  */
// function isTreasurer() {
//     return getCurrentUserType() === 'Treasurer';
// }

// /**
//  * Check if the current user is a Resident (only)
//  * @return bool True if the user is a Resident only, false otherwise
//  */
// function isResidentOnly() {
//     return getCurrentUserType() === 'Resident';
// }
...
//         'manage_residents' => ['Manager'],
//         'view_residents' => ['Manager', 'Treasurer'],
        
//         // Clearance features
//         'manage_clearance' => ['Manager'],
//         'view_all_clearances' => ['Manager', 'Treasurer'],
        
//         // Financial features
//         'manage_rental_fees' => ['Manager'],
//         'view_all_rental_fees' => ['Manager', 'Treasurer'],
//         'manage_fines' => ['Manager', 'Treasurer'],
//         'view_all_fines' => ['Manager', 'Treasurer'],
//         'view_payment_history' => ['Manager', 'Treasurer'],
        
//         // Room features
//         'manage_room_status' => ['Manager'],
//         'view_all_rooms' => ['Manager', 'Treasurer'],
        
//         // Document features
//         'manage_documents' => ['Manager'],
//         'view_all_documents' => ['Manager', 'Treasurer']
//     ];
    
//     // If the feature isn't defined, deny access
//     if (!isset($accessRules[$feature])) {
//         return false;
//     }
    
//     // Check if the user's type is in the allowed types for this feature
//     return in_array($userType, $accessRules[$feature]);
// }
